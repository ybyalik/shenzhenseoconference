          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="group cursor-pointer" data-testid="stat-attendees">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/30 border border-purple-200 dark:border-purple-800 rounded-2xl p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-purple-300 dark:hover:border-purple-700">
                ...
                <div className="text-3xl md:text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors">500+</div>
                <div className="text-sm font-medium text-purple-700 dark:text-purple-300">Attendees Expected</div>
                <div className="text-xs text-purple-600/70 dark:text-purple-400/70 mt-1">From around the world</div>
              </div>
            </div>
            
            {/* Speakers Stat */}
            <div className="group cursor-pointer" data-testid="stat-speakers">
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-950/20 dark:to-pink-900/30 border border-pink-200 dark:border-pink-800 rounded-2xl p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-pink-300 dark:hover:border-pink-700">
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg" style={{ backgroundColor: '#ff007a' }}>
                  <Mic className="w-8 h-8 text-white" />
                </div>
                <div className="text-3xl md:text-4xl font-bold mb-2 transition-colors" style={{ color: '#ff007a' }}>40+</div>
                <div className="text-sm font-medium text-pink-700 dark:text-pink-300">World-Class Speakers</div>
                <div className="text-xs text-pink-600/70 dark:text-pink-400/70 mt-1">Industry leaders & experts</div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer" data-testid="stat-days">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/30 border border-purple-200 dark:border-purple-800 rounded-2xl p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-purple-300 dark:hover:border-purple-700">
                ...
                <div className="text-3xl md:text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors">5</div>
                <div className="text-sm font-medium text-purple-700 dark:text-purple-300">Days of Innovation</div>
                <div className="text-xs text-purple-600/70 dark:text-purple-400/70 mt-1">Sept 17-21, 2026</div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer" data-testid="stat-countries">
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-950/20 dark:to-pink-900/30 border border-pink-200 dark:border-pink-800 rounded-2xl p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-pink-300 dark:hover:border-pink-700">
                ...
                <div className="text-3xl md:text-4xl font-bold mb-2 transition-colors" style={{ color: '#ff007a' }}>30+</div>
                <div className="text-sm font-medium text-pink-700 dark:text-pink-300">Countries Represented</div>
                <div className="text-xs text-pink-600/70 dark:text-pink-400/70 mt-1">Global perspectives</div>
              </div>
            </div>
          </div>
        </div>
