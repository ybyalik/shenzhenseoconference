...
const SPEAKER_POOL: Speaker[] = [
  { name: 'Gary Illyes', country: 'United States', title: 'Search Relations, Google', img: '/assets/gary-illyes.webp' },
  { name: 'Lily Ray', country: 'United States', title: 'VP SEO Strategy & Research', img: '/assets/lily-ray.webp' },
  { name: 'Eli Schwartz', country: 'United States', title: 'Growth Advisor, Author of Product-Led SEO', img: '/assets/eli-schwartz.webp' },
  { name: 'Lars Lofgren', country: 'United States', title: 'CEO, Stone Press', img: '/assets/lars-lofgren.webp' },
  { name: 'Aleyda Solis', country: 'Spain', title: 'Founder, Orainti', img: '/figma-assets/a98cc2407eac3ef826ce296466a19c22b89a4777.jpg' },
  { name: 'Bernard Huang', country: 'United States', title: 'Co-founder, Clearscope', img: '/assets/bernard-huang.webp' },
  { name: 'Doug Pierce', country: 'United States', title: 'SEO Consultant', img: '/assets/doug-pierce.webp' },
  { name: 'Loki Yan', country: 'China', title: 'SEO Practitioner', img: '/assets/loki-yan.webp' },
  { name: 'Mads Singers', country: 'Denmark', title: 'Management Consultant', img: '/assets/mads-singers.webp' },
  { name: 'Megan Gougeon', country: 'United States', title: 'SEO Strategist', img: '/assets/megan-gougeon.webp' },
  { name: 'Mike Dee', country: 'United States', title: 'SEO Consultant', img: '/assets/mike-dee.webp' },
  { name: 'Nick Drewe', country: 'United Kingdom', title: 'Founder, WeThrift', img: '/assets/nick-drewe.webp' },
  { name: 'Owain Lloyd-Williams', country: 'United Kingdom', title: 'SEO Practitioner', img: '/assets/owain-lloyd-williams.webp' },
  { name: 'Victor Huynh', country: 'United States', title: 'SEO Consultant', img: '/assets/victor-huynh.webp' },
  { name: 'Zack Franklin', country: 'United States', title: 'SEO agency owner, 7-figures', img: '/assets/zack-franklin.webp' },
...
const FIELD_TALKS: Speaker[] = [
  ...
  { name: 'Nik Ranger', country: 'Australia', title: 'Senior Growth Consultant, Dejan', img: '/assets/nik-ranger.webp' },
...
const WHO_TOOK_STAGE = [
  ...
  { name: 'Stewart Vickers', title: 'SEO Practitioner', img: '/assets/mike-dee.webp' },
  ...
  { name: 'Gary Illyes', title: 'Search Relations, Google', img: '/assets/gary-illyes.webp' },
  { name: 'Lily Ray', title: 'VP SEO Strategy & Research', img: '/assets/lily-ray.webp' },
  { name: 'Eli Schwartz', title: 'Growth Advisor', img: '/assets/eli-schwartz.webp' },
  { name: 'Lars Lofgren', title: 'CEO, Stone Press', img: '/assets/lars-lofgren.webp' },
  { name: 'Bernard Huang', title: 'Co-founder, Clearscope', img: '/assets/bernard-huang.webp' },
  { name: 'Doug Pierce', title: 'SEO Consultant', img: '/assets/doug-pierce.webp' },
  { name: 'Loki Yan', title: 'SEO Practitioner', img: '/assets/loki-yan.webp' },
  { name: 'Mads Singers', title: 'Management Consultant', img: '/assets/mads-singers.webp' },
  { name: 'Megan Gougeon', title: 'SEO Strategist', img: '/assets/megan-gougeon.webp' },
  { name: 'Mike Dee', title: 'SEO Consultant', img: '/assets/mike-dee.webp' },
  { name: 'Nick Drewe', title: 'Founder, WeThrift', img: '/assets/nick-drewe.webp' },
  { name: 'Victor Huynh', title: 'SEO Consultant', img: '/assets/victor-huynh.webp' },
];
