...
/* ──────────────── DAY 1 AS TWO COLUMNS (the /agenda-2col trial) ─────────── */
...
const CONFERENCE_DAYS: ConferenceDay[] = [
  // The /agenda-2col trial: Day 1's two programmes sit side by side in one card
  // rather than as two stacked cards. Both are visible without clicking, and
  // the page stays shorter. The column headings keep the same anchor ids as
  // the real /agenda, so deep links behave identically here.
  {
    anchor: 'day-1',
